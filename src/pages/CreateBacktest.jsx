...
function CreateBacktest() {
    ...
    const [initialcashbalance,setinitialcashbalance] = useState(null)

    const handleSubmit = (e) => {
        e.preventDefault()
        console.log(name, balance, startDate, endDate, selectedStrategyId)
        setStartDate('01/12/2012') 
        setEndDate('31/12/2022')
        setSelectedStrategyId('643c1a4b86336c639fbe5a54')
        setSymbolName('SONATASOFTW')
        setinitialcashbalance('100000')
        axios.get('http://localhost:8000/backtest/createbacktest?name='+name+'&initialcashbalance='+balance+selectedStrategyId+startDate+endDate+symbolname+initialcashbalance)
